...
from .views import LoginView, ProtectedDataView, LogoutAndBlacklistRefreshTokenForUserView, GetClassesForTheDay, AddClassToScheduler, RemoveClassFromScheduler, GetAlreadyEnrolledClasses, CustomTokenRefreshView
